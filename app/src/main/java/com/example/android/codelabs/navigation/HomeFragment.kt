...
//            //indNavController().navigate(R.id.flow_step_one_dest)
//        )
        //TODO END STEP 5
        ...
        view.findViewById<NavigationView>(R.id.shopping_cart)?.setOnClickListener{
            findNavController().navigate(R.id.shoppingFragment , null , options)
        }
    }
